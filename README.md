...
10.  Select xLODGenx64 from the upper right drop down bar and click Run.  
	- Tick all world spaces once the xLODGen window appears.  Tick Terrain LOD.  Leave Objects LOD, Trees LOD, and Occlusion unticked.  Then click Generate.
		- Close the window once you see "LOD generation complete".
...
11.  Navigate to your \DynDOLOD\ folder from Step 4 and move the \DynDOLOD_Output\ and \TexGen_Output\ to C:\(Your Game Folder Generated By Wabbajack)\mods\
12.  Launch Mod Organizer 2 and tick "DynDOLOD_Output" and "TexGen_Output" in the left window pane and ensure DynDOLOD.esp is ticked in the right window pane.  
