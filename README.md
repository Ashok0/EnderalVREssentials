...
5.  Create a new folder where you wish to install Enderal VR i.e. C:\Games\Enderal VR
...
8.  Under "Installation Location", select the folder you created above under Step 5 and then click the green "PLAY" icon in the lower right. 
...
10. Once Wabbajack is done downloading and configuring Enderal VR, navigate to your game folder from Step 5.
...
3. Install the following prerequisite mods through Mod Organizer 2:
	- [SKSE VR](https://skse.silverlock.org/beta/sksevr_2_00_12.7z) scripts folder
	- [PapyrusUtil VR](https://www.nexusmods.com/skyrimspecialedition/mods/13048?tab=files)
	- [DynDOLOD Resources SE 3.00](https://www.nexusmods.com/skyrimspecialedition/mods/32382?tab=files)(Under "Miscellaneous Files")
4. Download [DynDOLOD Standalone 3.0 Alpha-33] under "Miscellaneous Files" and extract the contents to a new \DynDOLOD\ directory that is outside of special OS folders like 'Programs Files' or 'Program Files (x86)', User, Documents, Desktop, Download and also not in SteamApps, game or any mod manager folders.
5. Launch Mod Organizer 2.
	...
	- Select the "Add from file..." icon (with the + symbol) > Navigate to "DynDOLODx64.exe" in the folder created in Step 4 and select Open.  Type -tes5vr under "Arguments" and click "Apply".  
	- Click OK to return to the main Mod Organizer 2 window. 
6.  Select TextGenx64 from the upper right drop down bar click Run.
...
7.  Select DynDOLODx64 from the upper right drop down bar click Run.
