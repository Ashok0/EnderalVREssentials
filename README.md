...
10.  Select xLODGenx64 from the upper right drop down bar and click Run.  
	...
	- xLODGen will create the following folder: c:\xLODGen_Output\. Move this folder to C:\ (Your Game Folder Generated By Wabbajack)\mods\  
...
13.  Right click Perfect Terrain LOD.esm in the right window pane and click "Open Origin in Explorer.  You can optionally delete Perfect Terrain LOD.esm as this file is no longer needed once your dynamic patches have all been generated. 
14.  DynDOLOD is now successfully configured!  You should see FAR more detail in the distance when looking across large open areas of the game!
